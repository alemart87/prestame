...
import { FiAward, FiTrendingUp, FiCheckCircle, FiDollarSign, FiZap, FiTarget, FiShield, FiStar, FiArrowRight, FiBarChart, FiUsers, FiClock, FiCpu, FiHelpCircle } from 'react-icons/fi';
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <GlassCard>
            <div className="divide-y divide-white/10">
              <FaqItem 
                question="¿Por qué mi Score es bajo si nunca pedí un préstamo?" 
                answer="Tu score no solo mide deudas. Considera tu estabilidad laboral, tus ingresos y la consistencia de tu información. Un score bajo puede ser simplemente falta de historial, ¡y aquí te ayudamos a construirlo!" 
              />
              <FaqItem 
                question="¿El análisis de IA es seguro?" 
                answer="Absolutamente. Nuestro análisis IA se enfoca en la estructura de tu comunicación y los datos que proporcionas, no en el contenido personal de tus conversaciones. Es una forma objetiva de medir responsabilidad y claridad, y todos tus datos están encriptados." 
              />
              <FaqItem 
                question="¿Tener un buen score me garantiza un préstamo?" 
                answer="Un score alto aumenta drásticamente tus posibilidades y te da acceso a mejores condiciones, ya que te presenta como un candidato confiable ante los inversionistas. Sin embargo, la decisión final siempre recae en el prestamista, quien evalúa el riesgo según sus propios criterios." 
              />
               <FaqItem 
                question="¿Cómo puedo empezar a mejorar mi score AHORA?" 
                answer="El primer paso es completar tu perfil al 100% con información veraz. Luego, interactúa con nuestro Asistente Financiero IA. Cada paso que das en la plataforma te ayuda a construir un perfil más sólido." 
              />
            </div>
          </GlassCard>
        </div>
