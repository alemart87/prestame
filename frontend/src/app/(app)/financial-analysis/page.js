                    ...
                    {/* Columna izquierda - Información */}
                        ...
                        >
                            ...
                            <FeatureCard 
                                ...
                                description="Nuestro asistente conversará contigo como lo haría una persona, adaptándose a tus respuestas para entender mejor tu situación."
                            ...
                            <FeatureCard 
                                ...
                                description="Analizamos patrones lingüísticos y respuestas para complementar tu perfil financiero con insights que los métodos tradicionales no pueden capturar."
                            ...
                            <FeatureCard 
                                ...
                                description="Tu privacidad es nuestra prioridad. Toda la información compartida durante la conversación está protegida y se utiliza exclusivamente para el análisis."
...
const FeatureCard = ({ icon, title, description, gradient, delay }) => (
    ...
    >
        <div className="flex items-center mb-4">
            <div className={`w-12 h-12 rounded-full bg-gradient-to-br ${gradient} flex items-center justify-center shadow-lg mr-4`}>
                {icon}
            </div>
